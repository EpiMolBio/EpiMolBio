...
public class Hilo_Lista_MDR implements Runnable{
    
    public static Thread t_lista_mdr;
    ...
    public Hilo_Lista_MDR(String entrada, String salida, int proteina){
        ...
        t_lista_mdr = new Thread(this, "Hilo_Lista_MDR");
        t_lista_mdr.start();
    ...
    public void run(){
        ...
        try {
            ...
            Lista_MDR.cargarListaMDR(this.entrada, this.salida, this.proteina);
            ...
            Logger.getLogger(Hilo_Lista_MDR.class.getName()).log(Level.SEVERE, null, ex);
