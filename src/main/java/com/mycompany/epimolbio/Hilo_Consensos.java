...
public class Hilo_Consensos implements Runnable {
    
    public static Thread t_consensos;
    ...
    public Hilo_Consensos(String rutaCarga, String rutaGuardado, int ronda, String longitud){
        ...
        t_consensos = new Thread(this, "Hilo_Consensos"); 
        t_consensos.start();
    ...
    public void run(){
        ...
        try {
            ...
            Consensos.cargarConsensos(this.rutaCarga, this.rutaGuardado, this.ronda, this.longitud);
            ...
            Logger.getLogger(Hilo_Consensos.class.getName()).log(Level.SEVERE, null, ex);
