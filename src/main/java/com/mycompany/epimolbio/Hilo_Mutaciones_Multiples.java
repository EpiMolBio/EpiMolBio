...
public class Hilo_Mutaciones_Multiples implements Runnable {
    
    public static Thread t_mutaciones_multiples;
    ...
    public Hilo_Mutaciones_Multiples(String archivoCarga, String archivoGuardado, String mutaciones, boolean modo){
        ...
        t_mutaciones_multiples = new Thread(this, "Hilo_Mutaciones_Multiples");
        t_mutaciones_multiples.start();
    ...
    public void run(){
        ...
        try {
            ...
            Mutaciones_Multiples.cargarMutacionesMultiples(this.archivoCarga, this.archivoGuardado, this.mutaciones, this.modo);
            ...
            Logger.getLogger(Hilo_Mutaciones_Multiples.class.getName()).log(Level.SEVERE, null, ex);
