...
public class Hilo_Mutaciones_Multiples_sc implements Runnable{
    
    public static Thread t_mutaciones_multiples_sc;
    ...
    public Hilo_Mutaciones_Multiples_sc(String archivoCarga, String archivoGuardado, String mutaciones){
        ...
        t_mutaciones_multiples_sc = new Thread(this, "Hilo_Mutaciones_Multiples_sc");
        t_mutaciones_multiples_sc.start();
    ...
    public void run(){
        ...
        try {
            ...
            Mutaciones_Multiples.lectorSubcarpetasMutacionesMultiples(this.archivoCarga, this.archivoGuardado, this.mutaciones);
            ...
            Logger.getLogger(Hilo_Mutaciones_Multiples_sc.class.getName()).log(Level.SEVERE, null, ex);
