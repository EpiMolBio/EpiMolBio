...
public class Hilo_Eliminar_Stops implements Runnable{
    
    public static Thread t_eliminar_stops;
    ...
    public Hilo_Eliminar_Stops(String entrada, String salida){
        ...
        t_eliminar_stops = new Thread(this, "Hilo_Eliminar_Stops");
        t_eliminar_stops.run();
    ...
    public void run(){
        ...
        try {
            ...
            Eliminar_Stops.cargarEliminarStops(entrada, salida);
            ...
            Logger.getLogger(Hilo_Eliminar_Stops.class.getName()).log(Level.SEVERE, null, ex);
